...
(function(){(function (global, factory) {
  ...
  var _assign = ReactInternals$2.assign;
  ...
  const _ReactInternals$Sched$1 = ReactInternals$1.Scheduler,
        unstable_cancelCallback = _ReactInternals$Sched$1.unstable_cancelCallback,
        unstable_now = _ReactInternals$Sched$1.unstable_now,
        unstable_scheduleCallback = _ReactInternals$Sched$1.unstable_scheduleCallback,
        unstable_shouldYield = _ReactInternals$Sched$1.unstable_shouldYield,
        unstable_requestPaint = _ReactInternals$Sched$1.unstable_requestPaint;
        _ReactInternals$Sched$1.unstable_getFirstCallbackNode;
        const unstable_runWithPriority = _ReactInternals$Sched$1.unstable_runWithPriority;
        _ReactInternals$Sched$1.unstable_next;
        _ReactInternals$Sched$1.unstable_continueExecution;
        _ReactInternals$Sched$1.unstable_pauseExecution;
        const unstable_getCurrentPriorityLevel = _ReactInternals$Sched$1.unstable_getCurrentPriorityLevel,
        unstable_ImmediatePriority = _ReactInternals$Sched$1.unstable_ImmediatePriority,
        unstable_UserBlockingPriority = _ReactInternals$Sched$1.unstable_UserBlockingPriority,
        unstable_NormalPriority = _ReactInternals$Sched$1.unstable_NormalPriority,
        unstable_LowPriority = _ReactInternals$Sched$1.unstable_LowPriority,
        unstable_IdlePriority = _ReactInternals$Sched$1.unstable_IdlePriority;
        _ReactInternals$Sched$1.unstable_forceFrameRate;
        _ReactInternals$Sched$1.unstable_flushAllWithoutAsserting;
   ...
   * 
   */
  let attemptSynchronousHydration$1;
  function setAttemptSynchronousHydration(fn) {
    attemptSynchronousHydration$1 = fn;
  }
  let attemptUserBlockingHydration$1;
  function setAttemptUserBlockingHydration(fn) {
    attemptUserBlockingHydration$1 = fn;
  }
  ...
  function replayUnblockedEvents() {
    ...
    while (queuedDiscreteEvents.length > 0) {
      ...
      if (nextDiscreteEvent.blockedOn !== null) {
        ...
        if (fiber !== null) {
          attemptUserBlockingHydration$1(fiber);
        }
  ...
  const _ReactInternals$Sched = ReactInternals.SchedulerTracing;
        _ReactInternals$Sched.__interactionsRef;
        _ReactInternals$Sched.__subscriberRef;
        _ReactInternals$Sched.unstable_clear;
        _ReactInternals$Sched.unstable_getCurrent;
        _ReactInternals$Sched.unstable_getThreadID;
        _ReactInternals$Sched.unstable_subscribe;
        _ReactInternals$Sched.unstable_trace;
        _ReactInternals$Sched.unstable_unsubscribe;
        _ReactInternals$Sched.unstable_wrap;
  ...
  Scheduler_now$1(); // If the initial timestamp is reasonably small, use Scheduler's `now` directly.
  ...
  const UserBlockingPriority$1 = unstable_UserBlockingPriority,
        runWithPriority$2 = unstable_runWithPriority; // TODO: can we stop exporting these?
  ...
  function dispatchDiscreteEvent(domEventName, eventSystemFlags, container, nativeEvent) {
    ...
    discreteUpdates$1(dispatchEvent, domEventName, eventSystemFlags, container, nativeEvent);
  }

  function dispatchUserBlockingUpdate(domEventName, eventSystemFlags, container, nativeEvent) {
    {
      runWithPriority$2(UserBlockingPriority$1, dispatchEvent.bind(null, domEventName, eventSystemFlags, container, nativeEvent));
    }
  }
  ...
  function extractEvents(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags, targetContainer) {
    ...
    if (shouldProcessPolyfillPlugins) {
      extractEvents$3(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags);
  ...
  function dispatchEventForPluginEventSystem(domEventName, eventSystemFlags, nativeEvent, targetInst, targetContainer) {
    ...
    batchedEventUpdates$1(() => dispatchEventsForPlugins(domEventName, eventSystemFlags, nativeEvent, ancestorInst));
  }
  ...
  function useMutableSource(hook, source, getSnapshot, subscribe) {
    ...
    if (!objectIs(prevGetSnapshot, getSnapshot) || !objectIs(prevSource, source) || !objectIs(prevSubscribe, subscribe)) {
      ...
      newQueue.dispatch = setSnapshot = dispatchAction.bind(null, currentlyRenderingFiber, newQueue);
  ...
  function mountEffect(create, deps) {
    ...
    return mountEffectImpl(Update | Passive$1, Passive, create, deps);
  }

  function updateEffect(create, deps) {

    return updateEffectImpl(Update | Passive$1, Passive, create, deps);
  }
  ...
  function startTransition(setPending, callback) {
    ...
    {
      runWithPriority$1(priorityLevel < UserBlockingPriority ? UserBlockingPriority : priorityLevel, () => {
        setPending(true);
      });
      runWithPriority$1(priorityLevel > NormalPriority ? NormalPriority : priorityLevel, () => {
        const prevTransition = ReactCurrentBatchConfig.transition;
        ReactCurrentBatchConfig.transition = 1;
  ...
  function mountOpaqueIdentifier() {
    ...
    if (getIsHydrating()) {
      ...
      if ((currentlyRenderingFiber.mode & BlockingMode) === NoMode) {
        currentlyRenderingFiber.flags |= Update | Passive$1;
        pushEffect(HasEffect | Passive, () => {
          setId(makeId());
        }, undefined, null);
      }
  ...
  function requestUpdateLane(fiber) {
    ...
    } else ; // The algorithm for assigning an update to a lane should be stable for all
  ...
  function discreteUpdates(fn, a, b, c, d) {
    ...
    {
      try {
        return runWithPriority$1(UserBlockingPriority, fn.bind(null, a, b, c, d));
      } finally {
        executionContext = prevExecutionContext;
  ...
  function completeUnitOfWork(unitOfWork) {
    ...
    do {
      ...
      if ((completedWork.flags & Incomplete) === NoFlags$1) {
        ...
        (returnFiber.flags & Incomplete) === NoFlags$1) {
  ...
  function commitBeforeMutationEffects() {
    while (nextEffect !== null) {
      ...
      if (!shouldFireAfterActiveInstanceBlur && focusedInstanceHandle !== null) {
        if ((nextEffect.flags & Deletion) !== NoFlags$1) {
  ...
  function flushPassiveEffectsImpl() {
    ...
    for (let i = 0; i < unmountEffects.length; i += 2) {
      ...
      if (typeof destroy === 'function') {
        {
          try {
            if (enableProfilerTimer && enableProfilerCommitHooks && fiber.mode & ProfileMode) ; else {
              destroy();
            }
          } catch (error) {
            if (!(fiber !== null)) {
  ...
  function createWorkInProgress(current, pendingProps) {
    ...
    if (workInProgress === null) {
      ...
      workInProgress.flags = NoFlags$1; // The effect list is no longer valid.
